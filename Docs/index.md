...
### Pragma Scopes ###
[Pragma Scopes](https://github.com/trijezdci/M2-Pragmas/blob/main/Docs/Pragma-Scopes.md)

### Pragma Placement ###
[Pragma Placement](https://github.com/trijezdci/M2-Pragmas/blob/main/Docs/Pragma-Placement.md)

### Pragma Specification ###
[Pragma Specification](https://github.com/trijezdci/M2-Pragmas/blob/main/Docs/Pragma-Specification.md)

### Pragma Grammar

#### Syntax Diagrams
[Syntax Diagrams](https://github.com/trijezdci/M2-Pragmas/blob/main/Docs/Syntax-Diagrams.md)
